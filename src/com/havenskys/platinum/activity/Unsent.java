...
public class Unsent extends ListActivity {
	...
	private void loadList() {
		// TODO Auto-generated method stub
		Cursor lCursor = mDataStore.detailQuery("messageStore", new String[] {
				"_id",
				"decrypted",
				"datetime(" + DbAdapter.COL_TIMEUPDATE
						+ "/1000, 'unixepoch', 'localtime') as date" },
				"status = 1", null, null, null, DbAdapter.COL_TIMEUPDATE
						+ " desc", null);
		...
		int[] to = new int[] { R.id.listrowunsentDescription,
				R.id.listrowunsentDate };

		// setTitle("Manual Sending, " + lCursor.getCount() + " Entries");
		SimpleCursorAdapter entries = new SimpleCursorAdapter(this,
				R.layout.listrowunsent, lCursor, from, to);
